...
public class Donhangchoxacnhan extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chitietdonhangchoxacnhan);
        imageView=findViewById(R.id.img);
        Intent intent=getIntent();
        int y=intent.getIntExtra("choxacnhan",0);
        donhangDao=new DonhangDao(Donhangchoxacnhan.this);
        giohangDao=new GiohangDao(Donhangchoxacnhan.this);
        khachhangDao=new KhachhangDao(Donhangchoxacnhan.this);
        sanphamDao=new SanphamDao(Donhangchoxacnhan.this);
        ...
        if(donhang.trangthai==2){
            ...
            vt.setText("do đơn hàng đã không được xác nhận");
        }
        if(donhang.trangthai==0){
            ...
            tv.setText("Đơn hàng đang được giao đến bạn");
