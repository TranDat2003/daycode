...
public class Giaohangthanhcong_Admin extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chidtietgiaohangthanhcong_admin);
        imageView=findViewById(R.id.img);
        Intent intent=getIntent();
        int y=intent.getIntExtra("choxacnhan",0);
        donhangDao=new DonhangDao(Giaohangthanhcong_Admin.this);
        giohangDao=new GiohangDao(Giaohangthanhcong_Admin.this);
        khachhangDao=new KhachhangDao(Giaohangthanhcong_Admin.this);
        sanphamDao=new SanphamDao(Giaohangthanhcong_Admin.this);
